...
mainframe=Frame(main,hex(252, 210, 185))
...
title = Label(verticalFrame, text='Enhancement of E-Government Services Using Machine learning', anchor=W,justify='center')
